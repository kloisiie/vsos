...
#ifndef _INCLUDE__LOWLEVEL_SESSION__LOWLEVEL_SESSION_H_
#define _INCLUDE__LOWLEVEL_SESSION__LOWLEVEL_SESSION_H_
...
namespace Lowlevel {
	...
	{
		static const char *service_name() { return "Lowlevel"; }
...
#endif /* _INCLUDE__LOWLEVEL_SESSION__LOWLEVEL_SESSION_H_ */
