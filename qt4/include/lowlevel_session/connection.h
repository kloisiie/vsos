...
#ifndef _INCLUDE__LOWLEVEL_SESSION__CONNECTION_H_
#define _INCLUDE__LOWLEVEL_SESSION__CONNECTION_H_

#include <lowlevel_session/client.h>
...
namespace Lowlevel {
	...
	struct Connection : Genode::Connection<Session>, Session_client
	{
		...
		:
			/* create session */
			Genode::Connection<Lowlevel::Session>(session("foo, ram_quota=4K")),
...
#endif /* _INCLUDE__LOWLEVEL_SESSION__CONNECTION_H_ */
