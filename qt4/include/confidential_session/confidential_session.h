...
#ifndef _INCLUDE__CONFIDENTIAL_SESSION__CONFIDENTIAL_SESSION_H_
#define _INCLUDE__CONFIDENTIAL_SESSION__CONFIDENTIAL_SESSION_H_
...
namespace Confidential {
	...
	{
		static const char *service_name() { return "Confidential"; }
...
#endif /* _INCLUDE__CONFIDENTIAL_SESSION__CONFIDENTIAL_SESSION_H_ */
