...
class Launch_entry : public Parent_element, public Loadbar_listener
{
	...
	public:
		 ...
		 * Constructor
		 */
		Launch_entry(const char *prg_name, const char *app_name,int initial_quota, int max_quota,
		             Launchpad  *launchpad,
		...
		{
			_block.append_launchertext(app_name, &link_style, &_launcher);
		...
		void loadbar_changed(int mx)
		{
			...
			//PDBG("Smeller:Launch_entry handle the event\n");
