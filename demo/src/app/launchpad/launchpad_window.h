                         ...
                         public Window
{
	...
	public:
		...
		void add_launcher(const char *filename,const char *appname,
		                  unsigned long default_quota,
		                  Genode::Dataspace_capability config_ds = Genode::Dataspace_capability(), int groupNum = 1)
		{
			Launch_entry<PT> *le;
			le = new Launch_entry<PT>(filename,appname, default_quota / 1024,
			                          initial_quota() / 1024,
			                          this, config_ds);
