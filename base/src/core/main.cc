...
int main()
{
	...
	static Signal_root  signal_root  (&sliced_heap, core_env()->cap_session());
        ...
        //add by wyq
	static Monitor_Root monitor_root (e,&sliced_heap);
        //end of add
	...
	static Local_service ls[] = {
		...
		Local_service(Monitor_Session::service_name(),  &monitor_root)       //add by wyq          
	};
